...
const PAGE_HELP: Record<DashboardView, PageHelp> = {
  'compra-materia-prima': {
    ...
    sections: [
      ...
      { title: 'Materia Prima por Proveedor/Gramaje — Mensual', body: 'Una sola tarjeta con las libras recibidas en los últimos 3 meses, agrupadas por mes y, a elección, por proveedor o por gramaje (talla del camarón, ej. "51/60") — usa el selector Proveedor/Gramaje para cambiar. Tiene vista de tabla, gráfica comparativa y gráfica de tendencia. El botón "Proveedores" abre una lista de casillas para elegir cuáles se muestran; esa selección se guarda en este navegador para tu usuario.' },
    ],
