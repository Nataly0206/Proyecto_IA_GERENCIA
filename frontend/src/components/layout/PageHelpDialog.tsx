...
const PAGE_HELP: Record<DashboardView, PageHelp> = {
  ...
  dashboard: {
    ...
    sections: [
      ...
      { title: 'Libras congeladas netas', body: 'Agrupa las libras por tipo de proceso e incluye FRESCO y REEMPAQUE como categorías independientes. El selector Procesos permite mostrar u ocultar cualquier categoría en las vistas Total, Día y Mensual.' },
  ...
  exportaciones: {
    ...
    sections: [
      ...
      { title: 'Por estilo y por cliente', body: 'El estilo explica la mezcla exportada y el cliente identifica el destino comercial. El selector Clientes está en los filtros superiores y afecta los indicadores semanales, las tarjetas por estilo, la tabla de contenedores y el reporte mensual. La selección se guarda en tu cuenta y se recupera al iniciar sesión desde otro dispositivo.' },
    ],
