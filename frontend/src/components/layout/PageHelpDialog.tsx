...
const PAGE_HELP: Record<DashboardView, PageHelp> = {
  ...
  clasificado: {
    ...
    sections: [
      ...
      { title: 'Por talla y por máquina', body: 'La sección por máquina o responsable responde al rango de fechas y turno. El botón “Ver por talla”, ubicado en su esquina superior derecha, abre una tabla de libras por talla con los mismos filtros y una fila de total. Las tablas "Clasificado por Talla" diaria y mensual muestran la evolución por talla; la mensual usa los últimos 12 meses.' },
    ],
